...
import { hardhatNamedAccounts } from '@zk-vote/common/src/constants';
import { getNetworks } from '@zk-vote/common/src/functions';
...
/**
 * loads network list and configsfrom '@zk-vote/common/src
 */
const networks = {
  ...getNetworks({
    accounts: {
